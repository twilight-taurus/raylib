...
typedef struct Model {
    ...
    float * vertices;       // non-indexed vertices.
    // Animation data
...
RLAPI GLFWwindow* InitWindow(int width, int height, const char *title);  // Initialize window and OpenGL context
...
RLAPI void DrawCircleLinesEx(int centerX, int centerY, float radius, float thickness, Color color);
...
RLAPI void DrawTriangleLinesEx(Vector2 v1, Vector2 v2, Vector2 v3, float thickness, Color color);        // Draw triangle outline (vertex in counter-clockwise order!)
